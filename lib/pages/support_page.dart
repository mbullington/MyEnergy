...
class _SupportPage extends State<SupportPage> {
  ...
  Widget _buildLeftMessage(BuildContext context, String message) {
    ...
    return SizedBox(width: query.size.width, child: Stack(children: [Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.only(topLeft: Radius.circular(12.0), topRight: Radius.circular(12.0), bottomLeft: Radius.circular(4.0), bottomRight: Radius.circular(12.0))
      ),
  ...
  Widget _buildRightMessage(BuildContext context, String message) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.only(topLeft: Radius.circular(16.0), topRight: Radius.circular(16.0), bottomLeft: Radius.circular(16.0), bottomRight: Radius.circular(8.0))
      ),
      child: Text(message, style: textTheme.subhead.copyWith(color: Colors.white))
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: Column(children: <Widget>[
          ...
          _buildLeftMessage(context, "Dominion Energy has received your request. You're currently 6th in line..."),
          _buildLeftMessage(context, "You can either stay in this window or close the app, we'll notify you once we connect you to a specialist."),
          _buildLeftMessage(context, "Thanks!"),
        ]..addAll(messages.map((message) => _buildRightMessage(context, message)))..add(_buildTextComposer(context)), crossAxisAlignment: CrossAxisAlignment.end));
  }
}
